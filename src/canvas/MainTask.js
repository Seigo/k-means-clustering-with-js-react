...
// const run = (ctx) => {
//     Data.getX().forEach((x) => {
//         ctx.fillRect(x[0] * 50, x[1] * 50, 5, 5)
//     })
...
function moveMeans() {
    ...
    let meanWithNoPointsFound = false
    for (var mean_index in sums)
    {
        console.log(counts[mean_index]);
        if ( 0 === counts[mean_index] ) 
        {
            meanWithNoPointsFound = true
    ...
    if (means.toString() !== sums.toString() || meanWithNoPointsFound)
    {
        moved = true;
    }
